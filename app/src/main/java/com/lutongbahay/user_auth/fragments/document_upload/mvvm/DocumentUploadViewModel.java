...
public class DocumentUploadViewModel extends ViewModel {
    ...
    public LiveData<ResponseDocument> documentUpload(Context context, @Part RequestBody userId, List<MultipartBody.Part> files){
        return MainService.documentUpload(context, userId, files);
    }
}
