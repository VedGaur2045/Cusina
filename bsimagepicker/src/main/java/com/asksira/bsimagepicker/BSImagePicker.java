...
public class BSImagePicker extends BottomSheetDialogFragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView toolBarTitleTxt = view.findViewById(R.id.titleName);
        toolBarTitleTxt.setVisibility(View.VISIBLE);
...
//        });
        ...
        view.findViewById(R.id.closeImgBtn).setVisibility(View.VISIBLE);

        view.findViewById(R.id.closeImgBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
