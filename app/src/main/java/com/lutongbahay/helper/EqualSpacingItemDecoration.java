...
public class EqualSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean onlyLeftRightSpace;
    ...
    //dont give padding to top and bottom
    public EqualSpacingItemDecoration(int spacing, int displayMode, boolean onlyLeftRightSpace) {
        this.spacing = spacing;
        this.displayMode = displayMode;
        this.onlyLeftRightSpace = onlyLeftRightSpace;
    }
