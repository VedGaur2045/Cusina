...
public class FragmentUtils {
    ...
    public static void onChangeFragment(FragmentManager fragmentManager,
                                        int frameId,
                                        Fragment fragment,
                                        String tag) {
    ...
    public static void replaceFragmentCommon(FragmentManager fragmentManager,
                                             int containerID,
                                             Fragment fragment,
                                             String tag,
        ...
        Logger.DebugLog("Fragment OTPUtils", "Is popped Out : " + tag + " - " + fragmentPopped);
    ...
    public static void replaceFragmentWithLeftRightAnimation(FragmentManager fragmentManager,
                                                             int containerId,
                                                             Fragment fragment,
                                                             String tag,
                                                             boolean isAddToBackStack,
    ...
    public static void addFragmentCommon(FragmentManager fragmentManager,
                                         int containerID,
                                         Fragment fragment,
                                         String tag,
                                         boolean isAddtoBackStack) {
