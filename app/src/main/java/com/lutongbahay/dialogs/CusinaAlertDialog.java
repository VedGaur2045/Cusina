...
public class CusinaAlertDialog extends DialogFragment {
    public static final String TAG = CusinaAlertDialog.class.getSimpleName();
    private Builder builder;
    private static CusinaAlertDialog instance = new CusinaAlertDialog();

    public static CusinaAlertDialog getInstance() {
        return instance;
    }

    private Unbinder unbinder;
    @BindView(R.id.alert_card_view)
    CardView cardView;
    @BindView(R.id.alert_dialog_image_view)
    ImageView image;
    @BindView(R.id.alert_dialog_title)
    TextView title;
    @BindView(R.id.alert_dialog_sub_title)
    TextView subTitle;
    @BindView(R.id.alert_dialog_body)
    TextView body;
    @BindView(R.id.alert_dialog_positive_button)
    Button positive;
    @BindView(R.id.alert_dialog_negative_button)
    Button negative;
    @BindView(R.id.alert_dialog_buttons_panel)
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (builder != null) {
            ...
            if (builder.getTitleColor() != 0) {
                title.setTextColor(ContextCompat.getColor(context, builder.getTitleColor()));
            }
            ...
            if (builder.getSubtitleColor() != 0) {
                subTitle.setTextColor(ContextCompat.getColor(context, builder.getSubtitleColor()));
            }
            ...
            if (builder.getBodyColor() != 0) {
                body.setTextColor(ContextCompat.getColor(context, builder.getBodyColor()));
            }

            if (builder.getPositiveButtonText() != null) {
                positive.setText(builder.getPositiveButtonText());
                if (builder.getPositiveTextColor() != 0) {
                    positive.setTextColor(ContextCompat.getColor(context, builder.getPositiveTextColor()));
                }
            ...
            if (builder.getNegativeButtonText() != null) {
                ...
                if (builder.getNegativeColor() != 0) {
                    negative.setTextColor(ContextCompat.getColor(context, builder.getNegativeColor()));
                }
            ...
            if (builder.getImageResource() != 0) {
                Drawable imageRes = VectorDrawableCompat.create(getResources(), builder.getImageResource(), context.getTheme());
    ...
    public static class Builder implements Parcelable {
        ...
        public Dialog show() {
            return CusinaAlertDialog.getInstance().show(((Activity) context), this);
        }

        public void dismiss() {
            CusinaAlertDialog.getInstance().dismiss();
        }
    ...
    public static void showDCAlertDialog(@NonNull Context context, @DrawableRes int imageResource
            , String title, String subTitle, String body, String positiveButtonText,
                                         String negativeButtonText, CusinaAlertDialog.OnPositiveClicked onPositiveClicked, CusinaAlertDialog.OnNegativeClicked onNegativeClicked) {
        CusinaAlertDialog.Builder alert = new CusinaAlertDialog.Builder(context)
                ...
                .setOnNegativeClicked(onNegativeClicked)
                .setPositiveButtonText(positiveButtonText)
                //.setPositiveColor(R.color.colorPositive)
                .setOnPositiveClicked(onPositiveClicked)
                .setBodyGravity(CusinaAlertDialog.TextGravity.CENTER)
                .setTitleGravity(CusinaAlertDialog.TextGravity.CENTER)
                .setSubtitleGravity(CusinaAlertDialog.TextGravity.CENTER)
                .setCancelable(false)
                .build();
        alert.show();
    }
